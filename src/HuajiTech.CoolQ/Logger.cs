...
namespace HuajiTech.CoolQ
{
    ...
    internal class Logger : ILogger
    {
        ...
        /// <param name="type">日志的类型。</param>
        /// <param name="message">日志的消息。</param>
        public void LogReceiving(string type, string message)
        {
        ...
        /// </summary>
        /// <param name="message">日志的消息。</param>
        public void LogReceiving(string message)
        {
        ...
        /// <param name="type">日志的类型。</param>
        /// <param name="message">日志的消息。</param>
        public void LogSending(string type, string message)
        {
        ...
        /// </summary>
        /// <param name="message">日志的消息。</param>
        public void LogSending(string message)
        {
